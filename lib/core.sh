...
source "${DEPLOY_FRAMEWORK_DIR}/backup.sh"
source "${DEPLOY_FRAMEWORK_DIR}/notify.sh"
source "${DEPLOY_FRAMEWORK_DIR}/compose.sh"
source "${DEPLOY_FRAMEWORK_DIR}/schedule.sh"
source "${DEPLOY_FRAMEWORK_DIR}/migrate.sh"
source "${DEPLOY_FRAMEWORK_DIR}/fleet.sh"
...
source "${DEPLOY_FRAMEWORK_DIR}/manager_args.sh"
source "${DEPLOY_FRAMEWORK_DIR}/manager_update.sh"
source "${DEPLOY_FRAMEWORK_DIR}/app.sh"
source "${DEPLOY_FRAMEWORK_DIR}/manager_security_doctor.sh"
