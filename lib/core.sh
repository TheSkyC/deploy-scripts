...
source "${DEPLOY_FRAMEWORK_DIR}/version_check.sh"
source "${DEPLOY_FRAMEWORK_DIR}/self_update.sh"
...
source "${DEPLOY_FRAMEWORK_DIR}/manager_backup.sh"
source "${DEPLOY_FRAMEWORK_DIR}/manager_update.sh"
